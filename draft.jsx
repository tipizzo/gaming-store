            ...
            <div className='flex  gap-8 game-card'>
                ...
                <div className='flex flex-col gap-2 cursor-pointer'>
                    <div>
                        ...
                        <span className='text-gray-400 font-bold text-sm px-1 rounded-xl'>Horror</span>
                    </div>
                ...
                <div className='flex flex-col gap-2 cursor-pointer'>
                    <div>
                        ...
                        <span className='text-gray-400 font-bold text-sm px-1 rounded-xl'>Racing</span>
                    </div>
                ...
                <div className='flex flex-col gap-2 cursor-pointer'>
                    <div>
                        <img src='/assets/hitm.png' alt='' className='h-[300px] w-[200px] rounded-lg mb-2' />
                        <span className='text-gray-400 font-bold text-sm px-1 rounded-xl'>Action & Adventure</span>
                    </div>
                    <h3 className='font-semibold text-xl'>HITMAN</h3>
                    <span className='font-bold bg-gray-600 text-gray-300 w-max px-2 rounded-lg'>Not available</span>
                    <span className='font-semibold'>Coming Soon</span>
                </div>
                <div className='flex flex-col gap-2 cursor-pointer'>
                    <div>
                        <img src='/assets/wukong.png' alt='' className='h-[300px] w-[200px] rounded-lg mb-2' />
                        <span className='text-gray-400 font-bold text-sm px-1 rounded-xl'>Action & Adventure</span>
                    </div>
                    <h3 className='font-semibold text-xl'>BLACK MYTH: WUKONG</h3>
                    <span className='font-bold bg-gray-600 text-gray-300 w-max px-2 rounded-lg'>Not available</span>
                    <span className='font-semibold'>Coming Soon</span>
                </div>
                <div className='flex flex-col gap-2 cursor-pointer'>
                    <div>
                        <img src='/assets/nba2k25.png' alt='' className='h-[300px] w-[200px] rounded-lg mb-2' />
                        <span className='text-gray-400 font-bold text-sm px-1 rounded-xl'>Sports</span>
                    </div>
                    <h3 className='font-semibold text-xl'>NBA 2K25</h3>
                    <span className='font-bold bg-gray-600 text-gray-300 w-max px-2 rounded-lg'>Available</span>
                    <span className='font-semibold'>Coming Soon</span>
                </div>
