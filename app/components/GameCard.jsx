    ...
    return (
        <div className='mx-44 mt-10 flex flex-col gap-5'>
            ...
            <div className='flex flex-col gap-2 cursor-pointer'>
                <div>
                    <img src='/assets/far-cry-xx.jpg' alt='' className='h-[300px] w-[250px] rounded-lg mb-2' />
                    <span className='text-gray-400 font-bold text-sm px-1 rounded-xl'>Base Game</span>
                </div>
                <h3 className='font-semibold text-xl'>FAR CRY 5</h3>
